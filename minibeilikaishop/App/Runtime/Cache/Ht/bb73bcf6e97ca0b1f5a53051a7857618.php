...
<script type="text/javascript" src="/minigueinon/Public/ht/js/jquery1.8.js"></script>
...
<script type="text/javascript" src="/minigueinon/Public/ht/js/jquery.XYTipsWindow.min.2.8.js"></script>
<script type="text/javascript" src="/minigueinon/Public/ht/js/mydate.js"></script>
<link href="/minigueinon/Public/ht/css/order.css" rel="stylesheet" type="text/css" />
</head>
<body>
      ...
      <table class="pro_3">
         ...
         <?php if(is_array($order_list)): $i = 0; $__LIST__ = $order_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$order): $mod = ($i % 2 );++$i;?><tr data-id="<?php echo ($order["id"]); ?>" data-name="<?php echo ($order["name"]); ?>">
		   ...
		   <td class="status">
		   	...
		   	<?php else: ?>
				<font class='font_color'><?php echo $order_status[$order['status']]?$order_status[$order['status']]:'已取消'; ?></font><?php endif; ?>
		   </td>
