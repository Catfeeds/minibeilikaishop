...
<script type="text/javascript" src="/minibeilikaishop/Public/plugins/xheditor/xheditor-1.2.1.min.js"></script>
<script type="text/javascript" src="/minibeilikaishop/Public/plugins/xheditor/xheditor_lang/zh-cn.js"></script>
<script type="text/javascript" src="/minibeilikaishop/Public/ht/js/jCalendar.js"></script>
<style>
...
<div class="aaa_pts_show_2">
    ...
    <div class="aaa_pts_3">
		<form action="<?php echo U('Video/add');?>?id=<?php echo ($id); ?>" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
		<ul class="aaa_pts_5">
			<li>
      ...
      <li>
          <div class="d1">视频缩略图:</div>
           <div>
            <?php if ($v['photo']) { ?>
                  <img src="/minibeilikaishop/Data/<?php echo $v['photo']; ?>" width="80" height="80" style="margin-bottom: 3px;" />
                  <br />
              <?php } ?>
...
<script type="text/javascript" src="/minibeilikaishop/Public/ht/js/product.js"></script>
<script>
