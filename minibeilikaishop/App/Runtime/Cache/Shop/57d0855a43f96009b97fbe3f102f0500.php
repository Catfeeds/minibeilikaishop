...
body{background:url("/minigueinon/Public/ht/images/login_01.jpg") repeat 0 0;}
.d1{background:url("/minigueinon/Public/ht/images/login_02.jpg") no-repeat center top; padding-top:373px; position:absolute; top:0; bottom:0; width:100%; min-width:1020px;}
...
.c2 li{width:195px; height:42px; margin-right:10px; background:url("/minigueinon/Public/ht/images/icon.jpg") no-repeat 9px 10px #fff; display:inline-block;}
...
<div class="d1">
   <div class="d2">
       ...
       <div class="c3">
          <input type="image" src="/minigueinon/Public/ht/images/submit.jpg" name="submit" value="1"/>
