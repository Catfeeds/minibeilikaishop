...
<script type="text/javascript" src="/minigueinon/Public/plugins/xheditor/xheditor-1.2.1.min.js"></script>
<script type="text/javascript" src="/minigueinon/Public/plugins/xheditor/xheditor_lang/zh-cn.js"></script>
<script type="text/javascript" src="/minigueinon/Public/ht/js/jCalendar.js"></script>
...
<![endif]-->
<link rel="stylesheet" type="text/css" href="/minigueinon/Public/hui/static/h-ui/css/H-ui.min.css" />
<link rel="stylesheet" type="text/css" href="/minigueinon/Public/hui/static/h-ui.admin/css/H-ui.admin.css" />
<link rel="stylesheet" type="text/css" href="/minigueinon/Public/hui/lib/Hui-iconfont/1.0.8/iconfont.css" />

<link rel="stylesheet" type="text/css" href="/minigueinon/Public/hui/static/h-ui.admin/skin/default/skin.css" id="skin" />
<link rel="stylesheet" type="text/css" href="/minigueinon/Public/hui/static/h-ui.admin/css/style.css" />


<link href="/minigueinon/Public/hui/lib/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
</head>
<body>
  ...
  <form action="?id=<?php echo ($id); ?>&page=<?php echo ($page); ?>&type=<?php echo ($type); ?>&name=<?php echo ($name); ?>&shop_id=<?php echo ($shop_id); ?>" method="post" onsubmit="return ac_from();" enctype="multipart/form-data" class="form form-horizontal" id="form-article-add">
    ...
    <?php else: ?>
      ...
      <div class="formControls col-xs-8 col-sm-9">
        ...
        <!-- 规格 end -->
         原价:<input class="input-text" name="price[]" id="price" style="width:50px;"/>
          优惠价:<input class="input-text" name="price_yh[]" id="price_yh" style="width:50px;"/>
     ...
     <!-- <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <select  class="input-text" name="spec" id="spec" style="width:150px;margin-right:5px;">
          <option value="">选择规格</option>
          <?php if(is_array($spec_list)): $i = 0; $__LIST__ = $spec_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["id"]); ?>"><?php echo ($v["spec_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
        </select>
        <select name="spec_value" id="spec_value" class="input-text hid" style="width:150px;margin-right:5px;"></select>
      </div>
    </div> -->
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">产品单位：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input class="input-text" style="width:100px;" name="company" id="company" value="<?php echo ($pro_allinfo["company"]); ?>"/><span style="color:red;font-size: 12px;">&nbsp;&nbsp;举例:个/只/件&nbsp;&nbsp;请根据产品来自行添加相应单位</span>
      </div>
    </div>
    <!-- <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">原价：</label>
      <div class="formControls col-xs-8 col-sm-9">
         <input class="input-text" name="price" id="price" value="<?php echo ($pro_allinfo2["price"]); ?>" style="width:500px;"/>
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">优惠价：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input class="input-text" name="price_yh" id="price_yh" value="<?php echo ($pro_allinfo2["price_yh"]); ?>" style="width:500px;"/>
      </div>
    </div> -->
     <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">赠送积分：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input class="input-text" name="price_jf" id="price_jf" value="<?php echo ($pro_allinfo["price_jf"]); ?>" style="width:100px;"/>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input class="input-text" name="pro_number" id="pro_number" value="<?php echo ($pro_allinfo["pro_number"]); ?>" style="width:500px;"/>
      </div>
    </div>
    <!-- <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">库存：</label>
      <div class="formControls col-xs-8 col-sm-9">
         <input class="input-text" name="num" id="num" value="<?php echo $pro_allinfo2['store']==0 ? 999999 : $pro_allinfo2['store']; ?>"  style="width:200px;"/>
          <span style="color:red;font-size: 12px;">&nbsp;&nbsp;请填写0~999999之间的数字</span>
      </div>
    </div> -->
    <div class="row cl">
         ...
         <div>缩略图：</div>
           <div>
            <?php if ($pro_allinfo2[0]['photo_x']) { ?>
                  <img src="/minigueinon/Data/<?php echo $pro_allinfo2[0]['photo_x']; ?>" width="80" height="80" style="margin-bottom: 3px;" />
                  <br />
              <?php } ?>
         ...
         <div>大图：</div>
           <div>
            <?php if ($pro_allinfo2[0]['photo_d']) { ?>
                  <img src="/minigueinon/Data/<?php echo $pro_allinfo2[0]['photo_d']; ?>" width="125" height="125" style="margin-bottom: 3px;" />
                <br />
              <?php } ?>
              ...
              <?php foreach ($img_str as $v) { ?>
               <div>
                <div class="img-err" title="删除" onclick="del_img('<?php echo $v; ?>',this);" style="color:red;cursor: pointer;">×</div>
                 ...
                 <?php }else{ ?>
                  <img src="<?php echo '/minigueinon/Data/'.$v; ?>" width="125" height="125">
                 <?php } ?>
               </div>
              <?php } ?>
...
<!--_footer 作为公共模版分离出去-->
<script type="text/javascript" src="/minigueinon/Public/hui/lib/jquery/1.9.1/jquery.min.js"></script> 
<script type="text/javascript" src="/minigueinon/Public/hui/lib/layer/2.4/layer.js"></script>
<script type="text/javascript" src="/minigueinon/Public/hui/static/h-ui/js/H-ui.min.js"></script> 
<script type="text/javascript" src="/minigueinon/Public/hui/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/minigueinon/Public/hui/lib/My97DatePicker/4.8/WdatePicker.js"></script>
<script type="text/javascript" src="/minigueinon/Public/hui/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="/minigueinon/Public/hui/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="/minigueinon/Public/hui/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="/minigueinon/Public/hui/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="/minigueinon/Public/hui/lib/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/minigueinon/Public/hui/lib/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/minigueinon/Public/hui/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
...
$(function(){
  ...
  var uploader = WebUploader.create({
    auto: true,
    swf: '/minigueinon/Public/hui/lib/webuploader/0.1.5/Uploader.swf',
  
    // 文件接收服务端。
    server: '/minigueinon/Public/hui/lib/webuploader/0.1.5/server/fileupload.php',
            ...
            if ( file.getStatus() === 'invalid' ) {
                ...
                uploader.makeThumb( file, function( error, src ) {
                    ...
                    if( isSupportBase64 ) {
                        ...
                        $.ajax('/minigueinon/Public/hui/lib/webuploader/0.1.5/server/preview.php', {
                            method: 'POST',
                            data: src,
                            dataType:'json'
...
<script type="text/javascript" src="/minigueinon/Public/ht/js/product.js"></script>
<script>
function upadd(obj){
  // alert('aaa');
