...
class IndexController extends PublicController {
    ...
    public function index(){
    	...
    	//首页推荐分类前八个
    	//======================
    	$procat = M('category')->where('bz_2=1 AND tid!=0')->order('bz_2 desc,sort desc')->field('id,name,bz_1')->limit(3)->select();
        ...
        //首页推荐人气商品
        //======================
        $renqi = M('product')->where('del=0 AND pro_type=1 AND is_down=0 AND type=1')->order('renqi desc')->limit(10)->select();
