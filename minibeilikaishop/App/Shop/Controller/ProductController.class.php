...
class ProductController extends PublicController{
	...
	public function add(){
		...
		// 查询所有属性
		//=========================
		$attr_list = M('attribute')->where('shop_id="'.$shop_id.'" OR shop_id=0')->select();
		$this->assign('attr_list',$attr_list);

		//=========================
		// 查询所有规格
		//=========================
		$spec_list = M('spec')->where('shop_id="'.$shop_id.'" OR shop_id=0')->select();
		$this->assign('spec_list',$spec_list);

		//=========================
		// 查询所有标签
		//=========================
		$tag_list = M('tag')->where('shop_id="'.$shop_id.'" OR shop_id=0')->select();
